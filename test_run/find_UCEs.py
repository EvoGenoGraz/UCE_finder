...
parser = argparse.ArgumentParser(description=DESCRIPTION, prog='find_UCEs.py', 
	...
	./find_UCEs.py --mummer_raw mummer.out --ref_fasta ref.fa --que_fasta que.fa --min_length 100 --max_merge_distance 40 --unique_distance 1000 --dist_from_end 10 --max_merge_distance_diff --extend 500 --output_length_dists
